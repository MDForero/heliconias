  ...
  return (
    <div className=' grid grid-cols-2 pt-8 gap-2'>
        ...
        <ul className='flex flex-row gap-2 place-content-end'>
            ...
            <li><a href='https://www.booking.com/hotel/co/centro-agroecoturistico-las-heliconias.es.html?lang=es'><Image loading='lazy'alt='logo de booking' src={booking} className='w-12 h-12'/></a></li>
