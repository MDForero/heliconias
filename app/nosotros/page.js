        ...
        <div className="bg-gray-900 text-gray-300 max-w-screen-2xl mx-auto text-justify ">
            ...
            <section className="">
                <article className="flex flex-wrap  justify-around content-center py-8 gap-4">
                    ...
                    <Image alt='mision y vision' src={mision} width={0} height={0} className="md:w-2/5 w-4/5 shadow-xl shadow-amber-800 rounded-2xl" />
                </article>
                <article className="flex flex-wrap flex-row-reverse justify-around content-center py-8 gap-4">
                    ...
                    <Image alt='mision y vision' src={vision} width={0} height={0} className="md:w-2/5 w-4/5 shadow-xl shadow-amber-800 rounded-2xl" />
                </article>
            </section>
            <Valores />
