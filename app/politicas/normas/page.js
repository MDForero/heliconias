    ...
    return <div>
        ...
        <article>
            ...
            <ol>
                ...
                <li>El uso de la piscina es exclusivo para huéspedes del hotel.</li>
                <li>El uso de la piscina es bajo su propio riesgo.</li>
                <li>Los niños menores de 12 años deben estar acompañados por un adulto.</li>
                <li>Los niños menores de 12 años deben usar flotadores.</li>



                <li>Evita acciones temerarias como lanzarte de cabeza al agua en partes de la piscina donde hay menos agua, podrías sufrir lesiones de consideración.</li>
                <li>Evita correr o jugar alrededor de la piscina, de las escaleras o los toboganes, dado que la mayoría del tiempo estos lugares están húmedos pueden volverse resbalosos y podrías caerte con facilidad.</li>
                <li> Es importante para la digestión y para evitar calambres dentro del agua que puedan hacernos sufrir un accidente que después de cada comida reposemos un rato, en el cual podemos jugar o dormir una siesta antes de volver al agua.</li>
